(() => {
  ...
  // extensions/product-discount-rust-block/src/DiscountFunctionSettings.jsx
  var import_react22 = __toESM(require_react());
  var import_jsx_runtime4 = __toESM(require_jsx_runtime());
  var TARGET = "admin.discount-details.function-settings.render";
  var DiscountFunctionSettings_default = reactExtension(TARGET, (api) => __async(void 0, null, function* () {
    const existingDefinition = yield getMetafieldDefinition(api.query);
    if (!existingDefinition) {
      const metafieldDefinition = yield createMetafieldDefinition(api.query);
  ...
  function CollectionsField({ defaultValue, value, onChange }) {
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Box2, { display: "none", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
      TextField2,
      {
        defaultValue,
  ...
  function PercentageField({ defaultValue, value, onChange, i18n }) {
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Box2, { paddingBlockEnd: "300", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(BlockStack2, { gap: "base", children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { variant: "headingMd", as: "h2", children: i18n.translate("description") }),
  ...
  function App() {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(FunctionSettings2, { onSave: applyExtensionMetafieldChange, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(Form2, { onReset: resetForm, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Section2, { padding: "base", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Box2, { padding: "base none", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
        CollectionsSection,
        {
          loading,
          selectedCollections,
  ...
  function CollectionsSection({
    ...
    const collectionRows = selectedCollections && selectedCollections.length > 0 ? selectedCollections.map((collection) => /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(BlockStack2, { gap: "base", children: [
          ...
          children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
              Button2,
              {
                ...
                children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Icon2, { name: "CircleCancelMajor" })
              }
            )
          ]
        }
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Section2, { children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(BlockStack2, { gap: "base", children: [
      loading ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(InlineStack2, { gap: true, inlineAlignment: "center", padding: "base", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ProgressIndicator2, {}) }) : null,
      collectionRows,
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Button2, { onClick: onClickAdd, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
        InlineStack2,
        {
          blockAlignment: "center",
          ...
          gap: "base",
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Icon2, { name: "CirclePlusMajor" }),
  ...
  function useExtensionData() {
    ...
    const initialMetafields = (data == null ? void 0 : data.metafields) || [];
    const [loading, setLoading] = (0, import_react22.useState)(false);
    const [percentage, setPercentage] = (0, import_react22.useState)(0);
    const [savedMetafields] = (0, import_react22.useState)(initialMetafields);
    const [selectedCollections, setSelectedCollections] = (0, import_react22.useState)([]);
    const [initialCollectionIds, setInitialCollectionIds] = (0, import_react22.useState)([]);
    const [initialSelectedCollections, setInitialSelectedCollections] = (0, import_react22.useState)(
      []
    );
    const [initialPercentage, setInitialPercentage] = (0, import_react22.useState)(0);
      ...
      function fetchInitialData() {
        return __async(this, null, function* () {
          ...
          const transferExcludedCollectionIds = parseTransferExcludedCollectionIdsMetafield(
            (_b = savedMetafields.find(
              (metafield) => metafield.key === "function-configuration"
            )) == null ? void 0 : _b.value
          );
          setInitialCollectionIds(transferExcludedCollectionIds);
          yield getCollectionTitles(transferExcludedCollectionIds, query).then(
            (results) => {
    ...
    const onPercentageValueChange = (value) => __async(this, null, function* () {
      setPercentage(Number(value));
    });
    function onSelectCollections() {
      return __async(this, null, function* () {
        const selection = yield resourcePicker({
          type: "collection",
    ...
    function applyExtensionMetafieldChange() {
      return __async(this, null, function* () {
  ...
  var METAFIELD_NAMESPACE = "$app:example-discounts--ui-extension";
  var METAFIELD_KEY = "function-configuration";
  ...
  `;
      const result = yield adminApiQuery(query);
      return (_b = (_a = result == null ? void 0 : result.data) == null ? void 0 : _a.metafieldDefinitions) == null ? void 0 : _b.nodes[0];
    });
  }
  ...
  `;
      ...
      const result = yield adminApiQuery(query, { variables });
      return (_b = (_a = result == null ? void 0 : result.data) == null ? void 0 : _a.metafieldDefinitionCreate) == null ? void 0 : _b.createdDefinition;
    });
  }
  function getCollectionTitles(collectionGids, adminApiQuery) {
    return __async(this, null, function* () {
...
//# sourceMappingURL=product-discount-rust-block.js.map
